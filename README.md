...
- Clonar el repositorio:
   ```shell
   $ git clone git@github.com:AlbertViCa/publica-suscribe-activemq.git
   $ cd publica-subscribe-activemq
   ```
...
- Instalamos las dependencias del sistema ejecutando:
   ...
   --------|---------|------------
   stomp.py   | 8.1.0   | Implementación del protocolo STOMP v1.x y que incuye la extensión de ActiveMQ
...
* **Naylea Castrellón Martínez**
* **Miguel Ángel Montoya  Celestino**
